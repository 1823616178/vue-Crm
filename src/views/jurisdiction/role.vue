    ...
    methods: {
      ...
      handleEdit(scope) {
        ...
        GetRoleRUle(this.Userid).then((res) => {
          ...
          // for(let prop in this.data.routes){
          //   arr.push(this.data.routes[prop])
          //   for(let key in this.data.routes[prop].children){
          //     arr[prop]['children'] = this.data.routes[prop].children
          //     console.log(this.data.routes[prop].children)
          //   }
          // }
          console.log(arr)
