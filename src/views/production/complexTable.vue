<template>
  <div class="app-container">
    ...
    <el-dialog :title="textMap[dialogStatus]"
      ...
      <div v-for="(item,index) in DataAbc"
           :key="index">
        <el-row type="flex"
                justify="center"
...
<script>
  import {productionList, fetchListS, createArticle, updataListlocalHost, GetComposeList} from '@/api/article'
