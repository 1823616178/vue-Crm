<template>
  <div class="app-container">
    ...
    <el-table :key="tableKey"
      ...
      <el-table-column :label="$t('table.author')"
                       width="110px"
                       align="center">
        <template slot-scope="scope">
      ...
      <el-table-column :label="$t('table.readings')"
                       align="center"
                       width="95">
        <template slot-scope="scope">
          <span v-if="scope.row.pageviews"
                class="link-type"
...
<script>
import { fetchListS, fetchPv, createArticle, updateArticle } from '@/api/article'
